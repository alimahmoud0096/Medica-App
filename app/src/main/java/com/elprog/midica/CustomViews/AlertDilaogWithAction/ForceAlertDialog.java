...
public class ForceAlertDialog extends DialogFragment implements View.OnClickListener {
    ...
    public static ForceAlertDialog newInstance(String str, String str2, int i) {
        ForceAlertDialog forceAlertDialog = new ForceAlertDialog();
        Bundle bundle = new Bundle();
        bundle.putString("title", str);
        bundle.putString("message", str2);
        bundle.putInt("img", i);
        forceAlertDialog.setArguments(bundle);
        return forceAlertDialog;
    }
